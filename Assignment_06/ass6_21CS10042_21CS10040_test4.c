...
int main() {
    ...
    printInt(ptrG1);
    printStr(", fptrG1 (adress, truncated to first 32 bits only) = ");
    printFlt(fptrG1);
    printStr(", strG1 = ");
    printStr(strG1);
    ...
    if(numG2 == numL1 && charG2 == charL1 && fltG2 == fltL1 && ptrG2 == ptrL1 && strG2 == strL1) {
    ...
    if(numL2 == numG1 && charL2 == charG1 && fltL2 == fltG1 &&  ptrL2 == ptrG1 && strL2 == strG1) {
    ...
    if(numG2 == numG1 && charG2 == charG1 && fltG2 == fltG1 && ptrG2 == ptrG1 && strG2 == strG1) {
